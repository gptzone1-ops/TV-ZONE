...
وضع الصيانة الطارئ لصفحة عملاء نتفلكس مفعّل افتراضياً. لإعادة الخدمة اضبط `VITE_NETFLIX_SERVICE_OUTAGE=false` ثم أعد نشر المشروع، ولتفعيله مجدداً استخدم القيمة `true`.

## منطق الروابط

- الحساب الخاص ينشئ 5 روابط: A/B/C/D/E.
- حساب نتفلكس المشترك الجديد ينشئ 8 روابط: رابطان لكل ملف من B إلى E، ويُتجاوز الملف A.
- رموز الملفات:
  - A: 1212
  - B: 2323
  - C: 3434
